...
export default function RandomJoke() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-[#79d082] to-[#245028] p-4">
      {/* Center the joke card within the screen */}
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md">
        {/* Header with title */}
        <h1 className="text-3xl text-orange-950 font-bold mb-4">
          😂 Random Joke 👈
        </h1>
